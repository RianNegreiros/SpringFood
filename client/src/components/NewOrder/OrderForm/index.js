...
export default function OrderForm() {
  ...
  return (
    <Form onSubmit={e => submitOrder(e)}>
      <h4 className='fw-bold mb-5'>Details</h4>
      <Form.Group>
      ...
      <div className="mt-5">
        <p className='fw-bolder'>Address to delivery:</p>
      ...
      {error && <Alert variant='custom-red' className="mt-4"> Error finishing order </Alert> }
    </Form>
  )
}